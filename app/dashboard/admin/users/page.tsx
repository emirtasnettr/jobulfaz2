...
export default function AdminUsersPage() {
  ...
  const getRoleBadge = useCallback((role: string) => {
    const configs: Record<string, { bg: string; text: string; label: string }> = {
      CANDIDATE: { bg: 'bg-blue-100', text: 'text-blue-700', label: 'Aday' },
        ...
        <header className="sticky top-0 z-30 bg-white/80 backdrop-blur-md border-b border-gray-100">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
            <div className="flex items-center gap-3">
              <Link href="/dashboard/admin" className="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-400 to-indigo-500 flex items-center justify-center hover:scale-105 transition-transform">
                ...
                <div className="flex flex-wrap gap-2">
                  {['ALL', 'CANDIDATE', 'MIDDLEMAN', 'CONSULTANT', 'ADMIN'].map((role) => {
                    ...
                    const roleColors: Record<string, string> = {
                      ...
                      'MIDDLEMAN': 'bg-blue-50 text-blue-700 hover:bg-blue-100',
                    ...
                    const activeColors: Record<string, string> = {
                      ...
                      'MIDDLEMAN': 'bg-blue-500 text-white',
                    ...
                    filteredUsers.map((user) => {
                      ...
                      const getStatusColor = (role: string) => {
                        switch (role) {
                          ...
                          case 'MIDDLEMAN': return 'bg-blue-100 text-blue-700';
          ...
          >
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="bg-gray-50 rounded-xl p-4">
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-blue-400 via-indigo-400 to-purple-400 flex items-center justify-center shadow-sm">
            ...
            <div className="p-6 border-t border-gray-200 flex items-center justify-end gap-3">
              ...
              <button
                ...
                disabled={isUpdating}
                className="px-6 py-2 text-sm font-medium text-white bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 rounded-lg transition-all shadow-sm hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed"
              >
