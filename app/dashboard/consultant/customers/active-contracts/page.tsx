/**
 * Aktif Sözleşmeler Sayfası
 * 
 * Consultant'ların aday tarafından kabul edilmiş iş ilanlarını görüntüleyebileceği sayfa
 */
...
interface JobPosting {
  ...
  acceptedCount: number; // Kabul edilmiş aday sayısı
}
  ...
  useEffect(() => {
    async function loadData() {
      try {
        ...
        // Aktif sözleşmeleri al (status = 'CURRENT')
        ...
        // Her iş ilanı için müşteri bilgilerini ve kabul edilmiş aday sayısını al
        const jobsWithDetails = await Promise.all(
          (jobs || []).map(async (job) => {
            ...
            // Kabul edilmiş aday sayısını al (status = 'ACCEPTED')
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#F4F9FE' }}>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-6">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Aktif Sözleşmeler</h1>
          <p className="text-sm text-gray-600">
            Aday tarafından kabul edilmiş iş ilanları
          </p>
        </div>
        ...
        <div className="bg-white rounded-xl border border-gray-200">
          <div className="p-6 border-b border-gray-200">
            <h3 className="text-lg font-semibold text-gray-900">Aktif Sözleşmeler ({jobPostings.length})</h3>
          </div>

          {jobPostings.length === 0 ? (
            <div className="p-12 text-center">
              <div className="text-gray-400 text-sm">
                Henüz aktif sözleşme bulunmuyor
              </div>
            </div>
          ) : (
                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-5 gap-4 text-sm">
                        ...
                        <div>
                          <span className="text-gray-500">Kabul Edilen:</span>
                          <p className="font-medium text-gray-900">{job.acceptedCount}/{job.required_count} aday</p>
                        </div>
                        <div>
